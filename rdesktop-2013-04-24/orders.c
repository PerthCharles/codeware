...
//extern uint16 second_order_count;
...
process_destblt(STREAM s, DESTBLT_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("DESTBLT(op=0x%x,x=%d,y=%d,cx=%d,cy=%d)\n",
...
process_patblt(STREAM s, PATBLT_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("PATBLT(op=0x%x,x=%d,y=%d,cx=%d,cy=%d,bs=%d,bg=0x%x,fg=0x%x)\n", os->opcode, os->x,
...
process_screenblt(STREAM s, SCREENBLT_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("SCREENBLT(op=0x%x,x=%d,y=%d,cx=%d,cy=%d,srcx=%d,srcy=%d)\n",
...
process_line(STREAM s, LINE_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("LINE(op=0x%x,sx=%d,sy=%d,dx=%d,dy=%d,fg=0x%x)\n",
...
process_rect(STREAM s, RECT_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("RECT(x=%d,y=%d,cx=%d,cy=%d,fg=0x%x)\n", os->x, os->y, os->cx, os->cy, os->colour);
//	}
...
process_desksave(STREAM s, DESKSAVE_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("DESKSAVE(l=%d,t=%d,r=%d,b=%d,off=%d,op=%d)\n",
...
process_triblt(STREAM s, TRIBLT_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("TRIBLT(op=0x%x,x=%d,y=%d,cx=%d,cy=%d,id=%d,idx=%d,bs=%d,bg=0x%x,fg=0x%x)\n",
//	       		os->opcode, os->x, os->y, os->cx, os->cy, os->cache_id, os->cache_idx,
...
process_polygon(STREAM s, POLYGON_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("POLYGON(x=%d,y=%d,op=0x%x,fm=%d,fg=0x%x,n=%d,sz=%d)\n",
...
process_polygon2(STREAM s, POLYGON2_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("POLYGON2(x=%d,y=%d,op=0x%x,fm=%d,bs=%d,bg=0x%x,fg=0x%x,n=%d,sz=%d)\n",
...
process_polyline(STREAM s, POLYLINE_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("POLYLINE(x=%d,y=%d,op=0x%x,fg=0x%x,n=%d,sz=%d)\n",
...
process_ellipse(STREAM s, ELLIPSE_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("ELLIPSE(l=%d,t=%d,r=%d,b=%d,op=0x%x,fm=%d,fg=0x%x)\n", os->left, os->top,
...
process_ellipse2(STREAM s, ELLIPSE2_ORDER * os, uint32 present, RD_BOOL delta)
{
	...
	//zhongbin
//	if(Toggled && NOT_END){
//		printf("ELLIPSE2(l=%d,t=%d,r=%d,b=%d,op=0x%x,fm=%d,bs=%d,bg=0x%x,fg=0x%x)\n",
...
process_orders(STREAM s, uint16 num_orders)
{
	...
	while (processed < num_orders)
	{
		...
		{
//			if(Toggled && NOT_END){
//				printf("#Here are some secondary orders#\n");//zhongbin
//			}
