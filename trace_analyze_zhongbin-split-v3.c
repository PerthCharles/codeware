...
void trace_split()
{
//adding this for solving the bug cause by adjacent 0xc8100000--------------
//otherwise there will make a "free double error" by free the same space in memory
//error may like this: 
//	***glibc detected*** doouble free or corruption(top)
if( (addr==last_addr)  && ( (addr^0xc8100000)==0 ) )
{
